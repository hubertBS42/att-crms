...
import fs from 'fs'
import { hashPasswordWithScrypt, verifyPasswordWithScrypt } from './utils'
import { sendEmail } from './nodemailer'
import SetPasswordEmail from './email-templates/set-password-email'
import ResetPasswordEmail from './email-templates/reset-password-email'
import PasswordUpdatedEmail from './email-templates/password-updated-email'
import InviteMemberEmail from './email-templates/invite-member-email'
...
export const auth = betterAuth({
	...
	emailAndPassword: {
		...
		password: {
			...
			verify: ({ hash, password }) => verifyPasswordWithScrypt(hash, password),
		},
		minPasswordLength: 6,
