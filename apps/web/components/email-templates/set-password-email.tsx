...
const SetPasswordEmail = ({ name, url }: SetPasswordEmailProps) => {
				...
				<Body className='bg-[#f4f4f5] m-auto font-sans'>
					<Container className='mx-auto my-10 max-w-120'>
						...
						<Section className='bg-white px-10 py-8'>
							<Heading className='text-[#18181b] text-xl font-semibold m-0 mb-2'>Welcome to {APP_NAME}</Heading>
							<Text className='text-[#71717a] text-sm leading-relaxed mt-0'>
								Hi {name}, an account has been created for you on {APP_NAME}. Click the button below to set your password and get started.
							</Text>
							...
							<Text className='text-[#71717a] text-xs leading-relaxed'>
								This link will expire in <strong>24 hours</strong>. If you weren&apos;t expecting this email, you can safely ignore it.
							</Text>
						...
						<Section className='bg-[#fafafa] rounded-b-xl border border-t-0 border-[#e4e4e7] px-10 py-6'>
							...
							<Text className='text-[#a1a1aa] text-xs text-center m-0 mt-1'>You&apos;re receiving this email because an account was created for you on {APP_NAME}.</Text>
						</Section>
					</Container>
				</Body>
			</Tailwind>
